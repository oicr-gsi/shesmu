...
syn keyword shesmuKeyword All Any By Count Default Define Dump Else EpochSecond EpochMilli First Fixed FixedConcat For Group In Input Let LexicalConcat Limit List Max Min Monitor None Reduce Reject Reverse Run Skip Smash Sort Squish Subsample Switch Then When Where While With
