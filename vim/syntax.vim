...
syn keyword shesmuKeyword All Any By Count Default Define Distinct Dump Else EpochSecond EpochMilli First Fixed FixedConcat For Group In Input Let LexicalConcat Limit List Matches Max Min Monitor None PartitionCount Reduce Reject Reverse Run Skip Smash Sort Squish Subsample Switch Then When Where While With
