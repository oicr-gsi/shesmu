...
public enum Comparison {
	...
	private static final Method METHOD_COMPARE_TO = new Method("compareTo", INT_TYPE, new Type[] { A_OBJECT_TYPE });
	...
	/**
	 * Whether this comparison only works for totally ordered types (integers and
	 * dates).
	 */
