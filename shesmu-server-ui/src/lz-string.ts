...
export const decompressFromBase64 = (input: string): string | null => {
  if (input === null || input === undefined) {
    return "";
  }
  if (input === "") {
...
export const compressToUTF16 = (input: string): string => {
  ...
  return (
    _compress(input, 15, (a: number): string => {
      return f(a + 32);
    }) + " "
  );
};

export const decompressFromUTF16 = (compressed: string): string | null => {
 ...
 */
export const decompressFromUint8Array = (
...
export const decompress = (compressed: string | null): string | null => {
  if (compressed === null || compressed === undefined) {
    return "";
  }
  if (compressed === "") {
