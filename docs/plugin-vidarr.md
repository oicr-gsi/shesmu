...
The Vidarr plugin provides an input format: `vidarr_analysis` which provides the analyis provenance data.

The `"versionTypes"` specifies the version keys that should be returned; if empty, 
