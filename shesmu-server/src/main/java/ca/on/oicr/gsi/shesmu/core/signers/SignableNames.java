...
@MetaInfServices
public final class SignableNames extends SignatureVariable {
	...
	private static final Method METHOD_TREE_SET__ADD = new Method("add", Type.BOOLEAN_TYPE,
			new Type[] { Type.getType(Object.class) });

	public SignableNames() {
		super("signable_names", SignatureStorage.STATIC_FIELD, Imyhat.STRING.asList());
	}
