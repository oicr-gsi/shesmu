...
public interface Throttler extends LoadedConfiguration {
	 ...
	 *
	 * @param services
	 *            a list of service names to check; this set must not be modified;
	 *            these names are arbitrary and must be coordinated by
	 *            {@link Action} and the throttler
