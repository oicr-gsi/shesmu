 ...
 *
 * This must be on static method in a subclass of
 * {@link FileBackedMatchedDefinitionRepository} or a virtual method on a
 * subclass of {@link FileBackedConfiguration} connected to a plugin
 */
@Retention(RUNTIME)
@Target(METHOD)
public @interface ShesmuMethod {
	 ...
	 *
	 * Use <tt>{instance}</tt> and <tt>{file}</tt> to include the name of the
	 * instance and file path.
	 */
	 ...
	 *
	 * Use <tt>$</tt> to insert an instance name.
	 */
