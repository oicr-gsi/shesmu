...
public interface UserDefiner {
	 ...
	 *
	 * @param name
	 *            the Shesmu name of the action
	 * @param description
	 *            the help text for the action
	 * @param clazz
	 *            the class which implements the actions
	 * @param supplier
	 *            a generator of new instances of this action
	 * @param parameters
	 *            the parameters that cannot be inferred by annotations
	 */
	public <A extends Action> void defineAction(String name, String description, Class<A> clazz, Supplier<A> supplier,
	 ...
	 * @param description
	 *            the help text for the constant
	 * @param type
	 *            the Shesmu type for the object
	 * @param value
	 ...
	 *            the help text for the constant
	 * @param type
	 *            the Shesmu type for the constant
	 * @param value
	 *            a callback to compute the current value of the constant
	 */
	 ...
	 * @param description
	 *            the help text of the function
	 * @param returnType
	 *            the returned Shesmu type of the function
	 * @param function
	 *            the implementation of the function
	 * @param parameters
	 *            the Shesmu types and help text of the parameters of the function
	 */
	 ...
	 *            the implementation of the function
	 */
	public <A, R> void defineFunction(String name, String description, TypeGlue<R> returnType, String parameterName,
			TypeGlue<A> parameterType, Function<A, R> function);
	 ...
	 *            the help text of the first parameter
	 * @param parameter1Type
	 *            the type of the first parameter
	 * @param parameter2Name
	 *            the help text of the second parameter
	 * @param parameter2Type
	 *            the type of the second parameter
	 * @param function
	 *            the implementation of the function
	 */
	public <A, B, R> void defineFunction(String name, String description, TypeGlue<R> returnType, String parameter1Name,
			TypeGlue<A> parameter1Type, String parameter2Name, TypeGlue<B> parameter2Type,
