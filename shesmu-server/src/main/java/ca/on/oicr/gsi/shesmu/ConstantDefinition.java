 ...
 * the program is recompiled even if the definition is changed.
 *
...
public abstract class ConstantDefinition implements Target {
	...
	public static ConstantDefinition ofBooleans(String name, Stream<Boolean> stream, String description) {
	...
	public static ConstantDefinition ofStrings(String name, Stream<String> stream, String description) {
