...
public abstract class ConstantDefinition implements Target {
  ...
  private static final Method INSTANT_CTOR =
      new Method("ofEpochMilli", Imyhat.DATE.asmType(), new Type[] {Type.LONG_TYPE});
  ...
  public static ConstantDefinition ofBooleans(
      String name, Stream<Boolean> stream, String description) {
  ...
  public static ConstantDefinition ofLongs(String name, Stream<Long> stream, String description) {
  ...
  public static ConstantDefinition ofStrings(
      String name, Stream<String> stream, String description) {
   ...
   *
   * <p>This must be a valid identifer.
   */
  @Override
